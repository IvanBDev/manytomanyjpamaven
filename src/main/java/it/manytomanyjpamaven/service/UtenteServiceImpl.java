...
import it.prova.manytomanyjpamaven.exception.UtentiConRuoliAssociatiException;
...
public class UtenteServiceImpl implements UtenteService {
	...
	public void rimuovi(Long idUtente) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			int utenteDaEliminare = utenteDAO.get(idUtente).getRuoli().size();
			if(utenteDaEliminare == 0)
				utenteDAO.delete(utenteDAO.get(idUtente));
			else
				throw new UtentiConRuoliAssociatiException("L' utente selezionato possiede dei ruoli..... Impossibile eliminare");
	...
	public List<Utente> trovaTuttiGliUtentiRegistratiAGiugno() throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findAllByDateOfJune2021();
	...
	public List<Utente> trovaTuttiGliUtentiConLaPasswordMinoreDi8Caratteri() throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findAllUsersWithPasswordLenghtEqualsTo8Characters();
	...
	public List<Utente> trovaTuttiGliUtentiConLoStatoDisabilitatoECheSonoAdmin() throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return utenteDAO.findAllUsersWithStatusDisabledIfThereAreAdmins();
